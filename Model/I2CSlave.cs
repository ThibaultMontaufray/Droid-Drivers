    ...
    public class I2CSlave : IDisposable
    {
        ...
        public void Read(byte[] readBuffer)
        {
            ...
            lock (_slaveDevice)
            {
                ...
                {
                    //TODO : Log.Write("I2C Error Communication");
                }
            }
        }
        ...
        public void Write(byte[] writeBuffer)
        {
            ...
            lock (_slaveDevice)
            {
                ...
                {
                    // TODO : Log.Write(Resources.StringResources.ErrorI2CCommunication.ToString());
                }
            }
        }
        ...
        public void WriteRegister(byte register, short value)
        {
            _writeBuffer[0] = (byte)(register * 3 - 2);
            _writeBuffer[1] = byte.Parse((value & 0x00FF).ToString());
            _writeBuffer[2] = byte.Parse((value >> 8).ToString());
            Write(_writeBuffer);
        }
        ...
        private byte[] _writeBuffer = new byte[3] { 0x00, 0x00, 0x00 };
    }
}
